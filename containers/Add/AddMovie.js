...
//mutations
import addMovie from '../../mutations/addMovie'
...
export default class AddMovie extends Component {
    ...
    render() {
        ...
        return (
            <ScrollView>
                <Text style={{fontSize:24, borderBottomWidth:1, marginBottom:10}}>Add a Movie</Text>
                <Query
                    style={{flex:1}}
                        query={getTags}
                    >
                ...
                <View>
                    ...
                    <Mutation mutation={addMovie} refetchQueries={()=> {
                            return[{
                                query: getMovies
                            }]
                        }} >
                        { (addMovie, {loading, error, data}) => (
                            ...
                            <Button 
                                title="Submit"
                                onPress={() => addMovie({variables:{title, overview, poster_path, popularity, tag, status}})}
                            />
